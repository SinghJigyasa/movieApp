    ...
    return(
        ...
        <div className="d-flex flex-column flex-shrink-0 p-3 text-white  ">
          ...
          <ul className="nav nav-pills flex-column mb-auto ">
            ...
            <li className="bg-danger border-0 rounded text-start p-2 ">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
              ...
              <Link className="link-offset-2 link-underline link-underline-opacity-0 text-white " to={'/'}> Home</Link>
            </li>
            <hr className="text-dark"/>
            <li className=" border rounded text-start p-2 text-dark">
